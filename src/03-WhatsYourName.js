...
var WhatsYourName = (function (_Component) {
  _inherits(WhatsYourName, _Component);
  ...
  _createClass(WhatsYourName, [{
    ...
    value: function render() {
      ...
      return _react2["default"].createElement(
        "div",
        null,
        _react2["default"].createElement("input", { type: "text", name: "name", onChange: this.onNameChange }),
